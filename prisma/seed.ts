...
async function main() {
  ...
  const resourcesData = [
    // Books (10)
    {
      ...
      availableCopies: 3,
      shelfLocation: 'CS-A1',
      abstract: 'A comprehensive textbook covering a broad range of algorithms in depth, yet makes their design and analysis accessible to all levels of readers.',
    ...
    },
    {
      ...
      availableCopies: 2,
      shelfLocation: 'SE-B2',
      abstract: 'A handbook of agile software craftsmanship that will instill within you the values of a software craftsman and make you a better programmer.',
    ...
    },
    {
      ...
      availableCopies: 4,
      shelfLocation: 'SE-B3',
      abstract: 'Elements of Reusable Object-Oriented Software. Captures a wealth of experience about the design of object-oriented software.',
    ...
    },
    {
      ...
      availableCopies: 2,
      shelfLocation: 'AI-C1',
      abstract: 'An introduction to a broad range of topics in deep learning, covering mathematical and conceptual background, deep learning techniques, and research perspectives.',
    ...
    },
    {
      ...
      availableCopies: 3,
      shelfLocation: 'SE-B4',
      abstract: 'Your journey to mastery. Examines the core process of software development with insights and practical advice for becoming a more effective programmer.',
    ...
    },
    {
      ...
      availableCopies: 3,
      shelfLocation: 'DB-D1',
      abstract: 'Presents the fundamental concepts of database management, covering relational model, SQL, database design, and transaction management.',
      publicationDate: '2019',
    ...
    },
    {
      ...
      availableCopies: 4,
      shelfLocation: 'OS-D2',
      abstract: 'The ninth edition of this best-selling text provides a solid theoretical foundation for understanding operating systems.',
    ...
    },
    {
      ...
      availableCopies: 2,
      shelfLocation: 'NW-E1',
      abstract: 'A comprehensive introduction to computer networks, covering the physical layer up through the application layer.',
    ...
    },
    {
      ...
      availableCopies: 1,
      shelfLocation: 'AI-C2',
      abstract: 'The most comprehensive and authoritative AI textbook available, covering the latest developments in the field.',
    ...
    },
    {
      ...
      abstract: 'A quantitative approach to computer architecture that explores the ways software and hardware interact in system design.',
    ...
    // Research (4)
    {
      ...
      availableCopies: 1,
      shelfLocation: 'ML-R1',
      abstract: 'A comprehensive introduction to machine learning that uses a probabilistic framework to unify the field.',
    ...
    },
    {
      ...
      abstract: 'Latest research articles in computer science covering algorithms, systems, and applications.',
    ...
    },
    {
      ...
      abstract: 'Conference proceedings from the 2025 Neural Information Processing Systems conference.',
      publicationDate: '2025',
    ...
    },
    {
      ...
      abstract: 'In-depth survey articles on topics across all areas of computer science.',
      publicationDate: '2025',
      subject: 'Computer Science',
    ...
    // Magazines (3)
    {
      ...
      abstract: 'Exploring the world through science, storytelling, and photography.',
    ...
    },
    {
      ...
      abstract: 'Authoritative coverage of science and technology developments.',
    ...
    data: [
      {
        ...
        type: 'due_date',
        title: 'Book Due Soon',
        message: 'Deep Learning is due in 0 days. Please return it on time to avoid late fees.',
        isRead: false,
      ...
      },
      {
        ...
        message: 'Deep Learning is now overdue. Please return it immediately to avoid penalties.',
        isRead: false,
      ...
      },
      {
        ...
        message: 'Your reserved book "Clean Code" is now available for pickup at the circulation desk.',
        isRead: false,
      ...
      },
      {
        ...
        message: 'The library will extend operating hours during finals week. Check the announcement for details.',
        isRead: true,
      ...
      },
      {
        ...
        message: 'Your borrowed book "ACM Computing Surveys" was returned late. A late fee may apply.',
        isRead: true,
    ...
    data: [
      {
        ...
        message: 'Starting March 25, the library will be open from 6:00 AM to 11:00 PM to support students during finals week. Regular hours will resume on April 5. Good luck with your exams!',
        targetRoles: 'all',
        isActive: true,
      },
      {
        title: 'New Arrivals: AI & Machine Learning Collection',
        message: 'We\'ve added 15 new titles to our AI and Machine Learning collection, including the latest editions of "Deep Learning" and "AI: A Modern Approach". Visit the AI section (Shelf AI-C) to check them out!',
        targetRoles: 'all',
        isActive: true,
      },
    ],
